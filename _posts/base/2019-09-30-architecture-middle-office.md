...
虽然中台在这几年变得非常的火，但是我理解这并不是一个全新的概念，我在华三工作的时候，公司的口号就是大平台，小产品。只是场景不同，交换机和路由是的协议都是标准的，所以华三的comware平台在设计之初就是平台化的。但是互联网行业是一个快速变化的行业，一个产品快速推出，快速迭代，随着用户和需求的增长系统不断的演进，最终导致多个产品之间有了很多重复开发的功能，然后回过头来进行平台化改造的过程。但是中台比一个产品的平台更难，因为**中台做的是一个企业级的架构**。
